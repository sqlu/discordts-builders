...
> [!TIP]
> **Performance Boost:** With over **5.6x performance** (more than 463% faster processing), `@discordts/builders` eliminates instantiation and serialization bottlenecks entirely, running close to 0ms overhead.
...
| :--- | :--- | :--- | :---: |
| **Instantiation** | ~165.9 ms | **~24.2 ms** | **6.8x faster** |
| **Serialization** | ~53.7 ms | **~14.8 ms** | **3.6x faster** |
| **Total** | ~219.7 ms | **~39.0 ms** | **5.6x faster** |
