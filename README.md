...
> [!TIP]
> **Performance Boost:** With over **6.5x performance** (more than 547% faster processing), `@discordts/builders` eliminates instantiation and serialization bottlenecks entirely, running close to 0ms overhead.
...
| :--- | :--- | :--- | :---: |
| **Instantiation** | ~158.1 ms | **~18.5 ms** | **8.5x faster** |
| **Serialization** | ~40.7 ms | **~12.2 ms** | **3.3x faster** |
| **Total** | ~198.8 ms | **~30.7 ms** | **6.5x faster** |
