...
> [!TIP]
> **Performance Boost:** With over **6.7x performance** (more than 567% faster processing), `@buncord/builders` eliminates instantiation and serialization bottlenecks entirely, running close to 0ms overhead.
...
*Last Benchmarked: June 22, 2026*

| Task | `@discordjs/builders` | `@buncord/builders` | Speed Comparison |
| :--- | :--- | :--- | :---: |
| **Instantiation** | ~150.8 ms | **~17.9 ms** | **8.4x faster** |
| **Serialization** | ~40.8 ms | **~10.9 ms** | **3.8x faster** |
| **Total** | ~191.6 ms | **~28.7 ms** | **6.7x faster** |
