...
> [!TIP]
> **Performance Boost:** With over **6.6x performance** (more than 559% faster processing), `@buncord/builders` eliminates instantiation and serialization bottlenecks entirely, running close to 0ms overhead.
...
| :--- | :--- | :--- | :---: |
| **Instantiation** | ~154.1 ms | **~17.6 ms** | **8.7x faster** |
| **Serialization** | ~43.0 ms | **~12.3 ms** | **3.5x faster** |
| **Total** | ~197.1 ms | **~29.9 ms** | **6.6x faster** |
